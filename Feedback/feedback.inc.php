...
// email setting //
 ...
 $mailto    = "aeroer.asiapacific@gmail.com , mdasifkhan@asiapacific.com";  // Recepient Email	
  ...
  $bccMail   = "feedback@asiapacific.com.my, mdasifkhan@asiapacific.com";  // leave it blank as options //

  $from      = "WING FENG SDN BHD";  // Name of the company where this form is belongs.

  $subject   = "WING FENG have enquiry From %name%";

  $smtpHost  = 'mail.wingfeng.com.my'; // eg. mail.absolutegardens.com.my -> ganti nama website tu je lps mail.__
